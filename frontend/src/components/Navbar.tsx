    ...
    <>
      ...
      >
        ...
        <div style={{ display: "flex", gap: 22, alignItems: "center", flexShrink: 0 }}>
          ...
          {/* START AUTH TOGGLE SECTION */}
          {user ? (
            <div style={{ display: "flex", alignItems: "center", gap: 20 }}>
              <span style={{ color: "#00d4ff", fontSize: 13, fontFamily: sans, fontWeight: 500 }}>
                {user.name || "User"}
              </span>
              <button
                onClick={() => { logout(); navigate("/"); }}
                style={{
                  background: "none", border: "none", color: "rgba(200,225,255,0.55)",
            ...
            <>
              <Link 
                ...
                onMouseEnter={e => (e.currentTarget.style.color = "rgba(200,225,255,0.9)")}
                onMouseLeave={e => (e.currentTarget.style.color = "rgba(200,225,255,0.55)")}
              >
                Sign In
              </Link>
              <button
